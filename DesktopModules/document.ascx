<%@ Control language="c#" Inherits="ASPNET.StarterKit.Portal.Document" CodeFile="Document.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
