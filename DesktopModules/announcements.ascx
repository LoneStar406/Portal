<%@ Control Language="c#" Inherits="ASPNET.StarterKit.Portal.Announcements" CodeFile="Announcements.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
