<%@ Control language="c#" Inherits="ASPNET.StarterKit.Portal.Signin" CodeFile="Signin.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
<%--
...
<table width="100%" cellspacing="0" cellpadding="4" border="0">
    <tr>
        <td>
            ...
            <br>
            <a href="Admin/Register.aspx"><img src="images/register2.gif" border="0"></a>
