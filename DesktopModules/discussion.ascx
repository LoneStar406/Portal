<%@ Control language="c#" Inherits="ASPNET.StarterKit.Portal.Discussion" CodeFile="Discussion.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
