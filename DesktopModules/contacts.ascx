<%@ Control language="c#" Inherits="ASPNET.StarterKit.Portal.Contacts" CodeFile="Contacts.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
