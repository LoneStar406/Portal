<%@ Control language="c#" Inherits="ASPNET.StarterKit.Portal.QuickLinks" CodeFile="QuickLinks.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
