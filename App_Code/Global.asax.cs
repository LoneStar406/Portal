...
namespace ASPNET.StarterKit.Portal {
    ...
    public class Global : System.Web.HttpApplication {
        ...
        public void Session_OnStart()
        {
            ...
            Session["ActivityLogID"] = LogDB.AddActivityLog(Context.Request.UserHostAddress,Context.Request.UserHostName);
            //Application.UnLock();
        }
        ...
        public void Session_OnEnd()
        {
            //Application.Lock();
            //Application["UsersOnline"] = (int)Application["UsersOnline"] - 1;
            LogDB.UpdateActivityLogOut((int)Session["ActivityLogID"]);
            //Application.UnLock();
        }
