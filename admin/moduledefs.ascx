<%@ Control Inherits="ASPNET.StarterKit.Portal.ModuleDefs" Language="c#" CodeFile="ModuleDefs.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
