<%@ Reference Control="~/admin/roles.ascx" %>
<%@ Control Inherits="ASPNET.StarterKit.Portal.Users" Language="c#" CodeFile="Users.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
