<%@ Control Inherits="ASPNET.StarterKit.Portal.SiteSettings" Language="c#" CodeFile="SiteSettings.ascx.cs" CodeFileBaseClass="ASPNET.StarterKit.Portal.PortalModuleControl" %>
