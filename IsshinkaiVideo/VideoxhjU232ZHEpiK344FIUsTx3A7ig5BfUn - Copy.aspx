<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VideoxhjU232ZHEpiK344FIUsTx3A7ig5BfUn.aspx.cs" Inherits="Video_Video" %>
...
‘Gancho’ which means glasses in Okinanawn language and explained that Shimabuku Tatsuo Sensei also called Advincula, Katagwa. Katagwa meaning Kata-man, because he was excellent in kata. The ‘gwa’ meaning ‘small in size’ compared to other Americans. 
                ...
                <table width="500" border="1" align="center" valign="top">
                    <tr>
                        ...
                        <td>
                        <div align="center"><img src="../images/windows_media_player.png" style="cursor:pointer" width="50" height="50" alt="" onclick="window.open('VideoStreaming.aspx?VideoName=VideoSEISAN', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');"/> 
		    ...
		    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <div align="center"><img src="../images/windows_media_player.png" style="cursor:pointer" width="50" height="50" alt="" onclick="window.open('VideoStreaming.aspx?VideoName=VideoBoCover', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');"/> 
                        <br /><a class="style30"  href="#" onclick="window.open('VideoStreaming.aspx?VideoName=VideoBoCover', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');">(Click to play)</a></div>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top"><div style="text-decoration:underline">Advincula Teaches the USMC - Basic Stance</div>
                            Advincula Teaches the USMC - Basic Stance.
                        </td>
                        <td>
                        <div align="center"><img src="../images/windows_media_player.png" style="cursor:pointer" width="50" height="50" alt="" onclick="window.open('VideoStreaming.aspx?VideoName=BasicStance', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');"/> 
                        <br /><a class="style30"  href="#" onclick="window.open('VideoStreaming.aspx?VideoName=BasicStance', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');">(Click to play)</a></div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td valign="top"><div style="text-decoration:underline">Advincula Teaches the USMC</div>
                            Advincula Teaches the USMC.
                        </td>
                        <td>
                        <div align="center"><img src="../images/windows_media_player.png" style="cursor:pointer" width="50" height="50" alt="" onclick="window.open('VideoStreaming.aspx?VideoName=SenseiTeachesUsmcm4v', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');"/> 
                        <br /><a class="style30"  href="#" onclick="window.open('VideoStreaming.aspx?VideoName=SenseiTeachesUsmcm4v', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');">(Click to play)</a></div>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top"><div style="text-decoration:underline">Advincula Teaches the USMC Part 2</div>
                            Advincula Teaches the USMC Part 2.
                        </td>
                        <td>
                        <div align="center"><img src="../images/windows_media_player.png" style="cursor:pointer" width="50" height="50" alt="" onclick="window.open('VideoStreaming.aspx?VideoName=SenseiTeachesUsmcPart2', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');"/> 
                        <br /><a class="style30"  href="#" onclick="window.open('VideoStreaming.aspx?VideoName=SenseiTeachesUsmcPart2', 'Test', 'width=680,height=530,scrollbars=yes,resizable=yes');">(Click to play)</a></div>
                        </td>
                    </tr>
